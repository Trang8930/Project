          ...
          <div className="text-content container">
            ...
            <div className="col-md-6">
              <div className="img-section">
                <img src="Restaurant-master/images/kabob.jpg" width={250} height={220} />
                <img src="Restaurant-master/images/limes.jpg" width={250} height={220} />
                <div className="img-section-space" />
                <img src="Restaurant-master/images/radish.jpg" width={250} height={220} />
                <img src="Restaurant-master/images/corn.jpg" width={250} height={220} />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="container">
              <div className="row">
                <div id="w">
                  ...
                  <ul id="portfolio">
                    <li className="item breakfast"><img src="Restaurant-master/images/food_icon01.jpg" alt="Food" />
                      <h2 className="white">$20</h2>
                    </li>
                    <li className="item dinner special"><img src="Restaurant-master/images/food_icon02.jpg" alt="Food" />
                      <h2 className="white">$20</h2>
                    </li>
                    <li className="item dinner breakfast"><img src="Restaurant-master/images/food_icon03.jpg" alt="Food" />
                      <h2 className="white">$18</h2>
                    </li>
                    <li className="item special"><img src="Restaurant-master/images/food_icon04.jpg" alt="Food" />
                      <h2 className="white">$15</h2>
                    </li>
                    <li className="item dinner"><img src="Restaurant-master/images/food_icon05.jpg" alt="Food" />
                      <h2 className="white">$20</h2>
                    </li>
                    <li className="item special"><img src="Restaurant-master/images/food_icon06.jpg" alt="Food" />
                      <h2 className="white">$22</h2>
                    </li>
                    <li className="item desert"><img src="Restaurant-master/images/food_icon07.jpg" alt="Food" />
                      <h2 className="white">$32</h2>
                    </li>
                    <li className="item desert breakfast"><img src="Restaurant-master/images/food_icon08.jpg" alt="Food" />
